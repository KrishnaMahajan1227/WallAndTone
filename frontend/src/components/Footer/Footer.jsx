      ...
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <div className="social-links">
            <a href="https://www.instagram.com/wallandtone?igsh=MW5hZzB0andydnpzNQ==" target="_blank" rel="noopener noreferrer" className="social-link" alt="insta-social-logo" aria-label="insta-social-logo">
            ...
            <a href="https://in.pinterest.com/wallandtone/?actingBusinessId=905997787446127979" className="pintrest-logo Scoial-logo" target="_blank" alt="pintrest-social-logo" aria-label="pintrest-social-logo">
            ...
            <a href="https://wa.me/message/57FQ46OW6LSKI1" className="whatsapp-logo Scoial-logo" target="_blank" alt="whatsapp-social-logo" aria-label="whatsapp-social-logo">
