  ...
  useEffect(() => {
    const fetchSubFrameTypes = async () => {
      if (selectedFrameType?._id) {
        try {
          const response = await axios.get(`http://wallandtone.com/api/sub-frame-types/${selectedFrameType._id}`);
    ...
    try {
      ...
      if (token) {
        const response = await axios.post(
          'http://wallandtone.com/api/cart/add',
          cartItem,
          {
  ...
  const handleAddToWishlist = async () => {
    ...
    try {
      ...
      const uploadResponse = await axios.post(
        'http://wallandtone.com/api/upload/image',
        imageFormData,
        {
          headers: {
      ...
      if (token) {
        const response = await axios.post(
          'http://wallandtone.com/api/wishlist/add',
          wishlistItem,
          {
            headers: { Authorization: `Bearer ${token}` }
          }
