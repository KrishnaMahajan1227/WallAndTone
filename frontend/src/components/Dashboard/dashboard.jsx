...
const Dashboard = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://wallandtone.com/api/users', {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const response = await axios.delete(`https://wallandtone.com/api/users/${id}`, {
        headers: {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await axios.put(`https://wallandtone.com/api/users/${editingUser._id}`, editingUser, {
        headers: {
