...
const ProductManager = () => {
  ...
  const fetchFrameTypes = async () => {
    try {
      const response = await axios.get('http://localhost:5000/api/frame-types');
  ...
  const fetchSubFrameTypes = async () => {
    try {
      const response = await axios.get('http://localhost:5000/api/sub-frame-types');
  ...
  const fetchSizes = async () => {
    try {
      const response = await axios.get('http://localhost:5000/api/admin/sizes/getsizes');
  ...
  const handleUploadExcel = async () => {
    ...
    try {
      await axios.post('http://localhost:5000/api/products/excel', formDataToSend);
      fetchProducts();
  ...
  const handleAddSubframeImage = async (e) => {
    ...
    try {
      await axios.post(
        `http://localhost:5000/api/products/${selectedProduct._id}/subframe-images`,
        formDataToSend,
        {
          headers: {
