...
function SizesAdmin() {
  ...
  useEffect(() => {
    if (token) {
      axios.get('http://backend.wallandtone.com/api/admin/sizes/getsizes', {
        headers: {
  ...
  const handleSubmit = (event) => {
    ...
    if (mode === 'create') {
      axios.post('http://backend.wallandtone.com/api/admin/sizes/addsize', {
        width,
        height,
        price,
      }, {
      ...
      axios.put(`http://backend.wallandtone.com/api/admin/sizes/updatesize/${id}`, {
        width,
        height,
        price,
      }, {
  ...
  const handleDelete = (id) => {
    axios.delete(`http://backend.wallandtone.com/api/admin/sizes/deletesize/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
