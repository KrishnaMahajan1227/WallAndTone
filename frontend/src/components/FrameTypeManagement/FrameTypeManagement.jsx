...
const FrameTypeManagement = () => {
  ...
  const fetchFrameTypes = async () => {
    try {
      const { data } = await axios.get('http://localhost:5000/api/frame-types');
      setFrameTypes(data);
  ...
  const fetchSubFrameTypes = async () => {
    try {
      const { data } = await axios.get('http://localhost:5000/api/sub-frame-types');
  ...
  const handleAddFrameType = async () => {
    ...
    try {
      const { data } = await axios.post('http://localhost:5000/api/frame-types', newFrameType);
  ...
  const handleAddSubFrameType = async () => {
    ...
    try {
      const { data } = await axios.post('http://localhost:5000/api/sub-frame-types', newSubFrameType);
  ...
  const handleUpdateFrameType = async () => {
    ...
    try {
      const { data } = await axios.put(`http://localhost:5000/api/frame-types/${editingFrameType._id}`, newFrameType);
  ...
  const handleUpdateSubFrameType = async () => {
    ...
    try {
      const { data } = await axios.put(`http://localhost:5000/api/sub-frame-types/${editingSubFrameType._id}`, newSubFrameType);
