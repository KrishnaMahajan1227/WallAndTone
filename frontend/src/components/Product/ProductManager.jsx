...
const ProductManager = () => {
  ...
  const fetchSubFrameTypes = async () => {
    try {
      const response = await axios.get('https://wallandtone.com/api/sub-frame-types');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = formData._id
        ? `https://wallandtone.com/api/products/${formData._id}`
        : 'https://wallandtone.com/api/products';
  ...
  const handleUploadExcel = async () => {
    ...
    try {
      await axios.post('https://wallandtone.com/api/products/excel', formDataToSend);
      fetchProducts();
  ...
  const handleAddSubframeImage = async (e) => {
    ...
    try {
      await axios.post(
        `https://wallandtone.com/api/products/${selectedProduct._id}/subframe-images`,
        formDataToSend,
        {
          headers: {
...
const handleSubframeImageChange = (e) => {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://wallandtone.com/api/products/${id}`);
