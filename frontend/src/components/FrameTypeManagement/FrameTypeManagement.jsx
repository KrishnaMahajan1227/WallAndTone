...
const FrameTypeManagement = () => {
  ...
  const fetchFrameTypes = async () => {
    try {
      const { data } = await axios.get('http://wallandtone.com/api/frame-types');
      setFrameTypes(data);
  ...
  const fetchSubFrameTypes = async () => {
    try {
      const { data } = await axios.get('http://wallandtone.com/api/sub-frame-types');
  ...
  const handleAddFrameType = async () => {
    ...
    try {
      const { data } = await axios.post('http://wallandtone.com/api/frame-types', newFrameType);
  ...
  const handleAddSubFrameType = async () => {
    ...
    try {
      const { data } = await axios.post('http://wallandtone.com/api/sub-frame-types', newSubFrameType);
  ...
  const handleUpdateFrameType = async () => {
    ...
    try {
      const { data } = await axios.put(`http://wallandtone.com/api/frame-types/${editingFrameType._id}`, newFrameType);
  ...
  const handleUpdateSubFrameType = async () => {
    ...
    try {
      const { data } = await axios.put(`http://wallandtone.com/api/sub-frame-types/${editingSubFrameType._id}`, newSubFrameType);
